    ...
    <footer className="relative bg-gradient-to-b from-slate-100 to-white dark:from-slate-900 dark:to-slate-950 border-t border-slate-200 dark:border-slate-700 overflow-hidden">
      ...
      <div className="relative mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <ul className="mt-12 flex flex-wrap justify-center gap-6 md:gap-8 lg:gap-12">
          ...
          <li className="relative group">
            <a className="text-slate-700 dark:text-slate-300 transition hover:text-transparent hover:bg-gradient-to-r hover:from-blue-600 hover:to-purple-600 hover:bg-clip-text font-medium" href="/contact"> Contact </a>
