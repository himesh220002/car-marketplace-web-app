    ...
    return (
        <div className=''>
            <div className='relative flex flex-col items-center p-2 sm:p-10 py-20 
                            gap-6 h-[500px] md:h-[650px] w-full object-cover hero-section-snap scroll-snap-start overflow-hidden'
                ...
                {/* Content */}
                <div className="relative z-10 flex flex-col items-center gap-6 mt-4 md:mt-20">
                    {/* Badge */}
                    ...
                    <h2 className='text-center text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-bold'>
